...
[argocd-kube]: https://https://argo.raptor-beta.ts.net/api/badge?name=kube-prometheus
[argocd-nvidia]: https://https://argo.raptor-beta.ts.net/api/badge?name=nvidia
[argocd-nfs]: https://https://argo.raptor-beta.ts.net/api/badge?name=nfs-provisioner
[argocd-crossplane]: https://https://argo.raptor-beta.ts.net/api/badge?name=crossplane
[argocd-ha]: https://https://argo.raptor-beta.ts.net/api/badge?name=homeassistant
[argocd-democratic-csi]: https://https://argo.raptor-beta.ts.net/api/badge?name=longhorn
[argocd-kuma]: https://https://argo.raptor-beta.ts.net/api/badge?name=uptime-kuma
[argocd-grocy]: https://https://argo.raptor-beta.ts.net/api/badge?name=grocy
[argocd-adguard]:https://https://argo.raptor-beta.ts.net/api/badge?name=adguard
[argocd-unifi-controller]: https://https://argo.raptor-beta.ts.net/api/badge?name=unifi-controller
[argocd-core]: https://https://argo.raptor-beta.ts.net/api/badge?name=argocd
[argocd-n8n]: https://https://argo.raptor-beta.ts.net/api/badge?name=n8n-service
[argocd-vault]: https://https://argo.raptor-beta.ts.net/api/badge?name=vault
[argocd-ha]: https://https://argo.raptor-beta.ts.net/api/badge?name=homeassistant
[argocd-wyze]: https://https://argo.raptor-beta.ts.net/api/badge?name=wyze
[argocd-redis]: https://https://argo.raptor-beta.ts.net/api/badge?name=redis
[argocd-matrix]: https://https://argo.raptor-beta.ts.net/api/badge?name=synapse
[argocd-mysql]: https://https://argo.raptor-beta.ts.net/api/badge?name=mysql-operator
[argocd-changedetection]: https://https://argo.raptor-beta.ts.net/api/badge?name=changedetection
[argocd-tailscale]: https://https://argo.raptor-beta.ts.net/api/badge?name=tailscale
[argocd-chatgpt]: https://https://argo.raptor-beta.ts.net/api/badge?name=discord-bot-gpt
[argocd-gitea]: https://https://argo.raptor-beta.ts.net/api/badge?name=gitea
[argocd-p-chatgpt]: https://https://argo.raptor-beta.ts.net/api/badge?name=memory-plugin-gpt
[argocd-milvus]: https://https://argo.raptor-beta.ts.net/api/badge?name=milvus-operator
[argocd-mongo]: https://https://argo.raptor-beta.ts.net/api/badge?name=mongodb-operator
[argocd-wavy]: https://https://argo.raptor-beta.ts.net/api/badge?name=wavy
[argocd-poller]: https://https://argo.raptor-beta.ts.net/api/badge?name=unifi-poller
[argocd-rss-gen]: https://https://argo.raptor-beta.ts.net/api/badge?name=rss-gen
[argocd-rss-hub]: https://https://argo.raptor-beta.ts.net/api/badge?name=rss-hub
[argocd-feedpushr]: https://https://argo.raptor-beta.ts.net/api/badge?name=feedpushr
[argocd-change]: https://https://argo.raptor-beta.ts.net/api/badge?name=changedetection
[argocd-beets]: https://https://argo.raptor-beta.ts.net/api/badge?name=beets
[argocd-lidarr]: https://https://argo.raptor-beta.ts.net/api/badge?name=lidarr
[argocd-metabase]: https://https://argo.raptor-beta.ts.net/api/badge?name=metabase
[argocd-kubevip]: https://https://argo.raptor-beta.ts.net/api/badge?name=kube-vip
[argocd-prowlarr]: https://https://argo.raptor-beta.ts.net/api/badge?name=prowlarr
[argocd-sonarr]: https://https://argo.raptor-beta.ts.net/api/badge?name=sonarr
[argocd-jellyfin]: https://https://argo.raptor-beta.ts.net/api/badge?name=jellyfin
[argocd-wallabag]: https://https://argo.raptor-beta.ts.net/api/badge?name=wallabag
[argocd-crossplane]: https://https://argo.raptor-beta.ts.net/api/badge?name=crossplane
[argocd-tailscale]: https://https://argo.raptor-beta.ts.net/api/badge?name=tailscale-operator
[argocd-agones]: https://https://argo.raptor-beta.ts.net/api/badge?name=agones
[argocd-gpu-exporter]: https://https://argo.raptor-beta.ts.net/api/badge?name=nvidia-exporter
[argocd-externaldns]: https://https://argo.raptor-beta.ts.net/api/badge?name=external-dns-cloudflare
[argocd-certmanager]: https://https://argo.raptor-beta.ts.net/api/badge?name=certmanager
[argocd-unifi]: https://https://argo.raptor-beta.ts.net/api/badge?name=unifi-controller
